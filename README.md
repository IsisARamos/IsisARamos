...
<p>
  Olá! Eu sou a <strong>Isis Ramos</strong>, curiosa por natureza e apaixonada pelo universo da programação. 🚀
  <br><br>
  Estou começando minha jornada do zero no mundo do desenvolvimento, explorando linguagens, ferramentas e tudo que esse universo tem a oferecer.
  <br><br>
  Acredito que a curiosidade é o melhor ponto de partida para aprender qualquer coisa — e é exatamente isso que me move! 💡
</p>

<p>🌱 Atualmente aprendendo: <strong>JavaScript, HTML, CSS e Node.js</strong></p>
...
<p align="center">
  ✨ <em>"A curiosidade é o começo de tudo."</em>
</p>
